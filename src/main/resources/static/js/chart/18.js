...
webSquid.page.modules["chart/18"] = webSquid.page.modules["chart/18"] || {
        ...
        query: function (appendTableHead) {
            webSquid.datatable("#query-c18-table", {
                paging: false,
                ordering: false,
                info: false,
                filter: false,
                data: webSquid.pageModule("chart/18").table_data,
                columns: webSquid.pageModule("chart/18").table_column
            });
            $("#query-c18-table thead").prepend(appendTableHead);
        },
        ...
        graph: function () {
            ...
            webSquid.ajax("data/s/HJ", "GET", {
                ...
                var m = webSquid.pageModule("chart/18");
                m.barLine_data1 = [];
                m.barLine_data2 = [];
                m.pie_legend_data = [];
                m.barLine_data_x = [];
