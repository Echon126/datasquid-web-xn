...
webSquid.page.modules["chart/19"] = webSquid.page.modules["chart/19"] || {
        ...
        query: function (appendTableHead) {
            webSquid.datatable("#query-c19-table", {
                paging: false,
                ordering: false,
                info: false,
                filter: false,
                data: webSquid.pageModule("chart/19").table_data,
                columns: webSquid.pageModule("chart/19").table_column
            });
            $("#query-c19-table thead").prepend(appendTableHead);
        },
        graph: function () {
            var sid = "";
            ...
            webSquid.ajax("data/s/HJ", "GET", {
                ...
                var m = webSquid.pageModule("chart/19");
                m.barLine_data1 = [];
                m.barLine_data2 = [];
                m.pie_data = [];
                m.pie_legend_data = [];
