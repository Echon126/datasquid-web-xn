...
webSquid.page.modules["chart/e6"] = webSquid.page.modules["chart/e6"] || {
        ...
        query: function () {
            ...
            var m = webSquid.pageModule("chart/e6");
            ...
            webSquid.ajax("data/s/HJ", "GET", {
                ...
                webSquid.datatable("#query-c6-table3", {
                    ...
                    info: false,
                    filter: false,
                    data: webSquid.pageModule("chart/e6").table3_data,
                    // order: [0, 'asc'],
                    columns: [
                        {
        ...
        graph: function () {
            webSquid.ajax("data/s/HJ", "GET", {
                ...
                webSquid.datatable("#query-c6-table1", {
                    ...
                    info: false,
                    filter: false,
                    data: webSquid.pageModule("chart/e6").table1_data,
                    columns: [
                        {
                            label: "周期", render: function (data, type, row) {
                            return row.company.split("-")[1];
            ...
            webSquid.ajax("data/s/HJ", "GET", {
                ...
                webSquid.datatable("#query-c6-table2", {
                    ...
                    info: false,
                    filter: false,
                    data: webSquid.pageModule("chart/e6").table2_data,
                    columns: [
                        {
                            label: "周期", render: function (data, type, row) {
                            return row.company.split("-")[1];
