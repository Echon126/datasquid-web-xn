...
webSquid.page.modules["chart/e20"] = webSquid.page.modules["chart/e20"] || {
        ...
        query: function (appendTableHead) {
            webSquid.datatable("#query-ce20-table", {
                paging: false,
                ordering: false,
                info: false,
                filter: false,
                data: webSquid.pageModule("chart/e20").table_data,
                columns: webSquid.pageModule("chart/e20").table_column
            });
            $("#query-ce20-table thead").prepend(appendTableHead);
        },
        ...
        graph: function () {
            ...
            if (webSquid.ie == "E") {
                ...
                // tid1 = "c20_tabledata_e";
                // tid2 = "c20_tablesum_e";
            } else {
                sid = "c18_barlinepie_i";
                // tid1 = "c20_tabledata_i";
                // tid2 = "c20_tablesum_i";
            }
            ...
            webSquid.ajax("data/s/HJ", "GET", {
                ...
                var m = webSquid.pageModule("chart/e20");
                m.barLine_data1 = [];
                m.barLine_data2 = [];
                m.pie_legend_data = [];
                m.barLine_data_x = [];
                ...
                for (var i = 0; i < rsp.data.length; i++) {
                    ...
                    pdata["value"] = (item.total_price / 10000).toFixed(2);
                    showTotalPrice += parseFloat(item.total_price);
                    m.barLine_data1.push((item.total_price / 10000).toFixed(2));
                ...
                webSquid.ajax("data/s/HJ", "GET", {
                    ...
                    // 饼状图 环形
                    var pieCharts = echarts.init(document.getElementById('c20_pie'));
                    m.graph_pie(pieCharts);
                });


                if (m.legend == null || m.legend.length == 0) {
                    $("#query-ce20-table").html("");
                    return;
                }
                ...
                webSquid.ajax("data/s/tradeCountry/HJ", "GET", {
                    ...
                    for (var i = 0; i < rsp.data.length; i++) {
                        ...
                        for (var j = 0; j < country_length; j++) {
                            ...
                            count = count + parseFloat(tdata["a" + j + "1"]);
