...
webSquid.page.modules["chart/e8"] = webSquid.page.modules["chart/e8"] || {


        //柱状图数据
        bar_title: '超长票数占比',
        bar_legend: ['全环节用时', '电商申报用时', '企业申报用时', '海关通关用时', '国检通关用时', '装机出港用时'],
        ...
        table1_data: [
            ...
            {link: '电商申报用时', ticket: '63', ratio: '9.31%'},
            {link: '企业申报用时', ticket: '34', ratio: '5.02%'},
            {link: '海关通关用时', ticket: '75', ratio: '11.08%'},
            {link: '国检通关用时', ticket: '36', ratio: '5.32%'},
            {link: '装机出港用时', ticket: '63', ratio: '9.31%'},
        ...
        see: function (clickBtn, type) {
            ...
            if(type=="all_time"){
                ...
                thresholdStr="gnwl";
            }else if(type=="zjcg_time"){
                thresholdStr="zjcg";
            }

            var linkName = $(clickBtn).parent().prev().prev().prev().html();
            if (null == linkName || null == linkName) linkName = "全环节用时";
            ...
            webSquid.ajax("data/s/HJ", "GET", {
                ...
                var m = webSquid.pageModule("chart/e8");
                m.table2_data = [];
                ...
                webSquid.datatable("#query-c8-table2", {
                    ordering: false,
                    data: webSquid.pageModule("chart/e8").table2_data,
                    columns: [
        ...
        query: function () {
            ...
            webSquid.ajax("data/s/HJ", "GET", {
                ...
                threshold: ["QHJ", "GJWL", "QYSB", "HGFX", "GJFX", "CYFJ", "HFCQ", "GNWL", "DSSB", "QYSB", "ZJCG"].join(";")
            }, function (rsp) {
                var m = webSquid.pageModule("chart/e8");
                var item = rsp.data[0];
                ...
                m.table1_data = [
                    ...
                    {link: '电商申报用时', ticket: item.dssb_time, ratio: '', type: 'dssb_time'},
                    {link: '企业申报用时', ticket: item.qysb_time, ratio: '', type: 'qysb_time'},
                    {link: '海关通关用时', ticket: item.hgtg_time, ratio: '', type: 'hgtg_time'},
                    {link: '国检通关用时', ticket: item.gjtg_time, ratio: '', type: 'gjtg_time'},
                    {link: '装机出港用时', ticket: item.zjcg_time, ratio: '', type: 'zjcg_time'}
                ];
                    ...
                    columns: [
                        ...
                        {data: "ratio", label: "占比"},
                        {
                            ...
                            render: function (data, type, row) {
                                ...
                                return "<button class='btn btn-primary btn-xs' onclick=\"webSquid.page.modules['chart/e8'].see(this, '" +
